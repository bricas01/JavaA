...
public class Register extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(layout.createSequentialGroup()
                .addComponent(txtuser, javax.swing.GroupLayout.PREFERRED_SIZE, 7, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(25, 25, 25)
                .addComponent(txtuserid, javax.swing.GroupLayout.PREFERRED_SIZE, 0, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void cmdregisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdregisterActionPerformed
        ...
        if(firstname.equals("") || lastname.equals("") || username.equals("") || password.equals("")){
            JOptionPane.showMessageDialog(null, "All fields cannot be empty", "Empty", ERROR_MESSAGE);
    ...
    private void txtusernameFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtusernameFocusLost
       try{
            ...
            String x = "SELECT * FROM Login WHERE username = ?";
            PreparedStatement pst1 = con.prepareStatement(x);
            pst1.setString(1,tusername);
            //pst.execute();
            ResultSet rs = pst1.executeQuery();
            while(rs.next()){
                String ttusername = rs.getString("username");
                if(tusername.equals(ttusername)){
                       JOptionPane.showMessageDialog(null, "Username already exist.", "Invalid", ERROR_MESSAGE);
